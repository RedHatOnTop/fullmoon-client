...
const P = {
  ...
  sparkles: (
    <>
      <path d="M12 4.5 13.6 9 18 10.5l-4.4 1.6L12 16.5l-1.6-4.4L6 10.5 10.4 9 12 4.5Z" />
      <path d="m18.6 15.6.8 2.1 2.1.8-2.1.8-.8 2.1-.8-2.1-2.1-.8 2.1-.8.8-2.1Z" />
      <path d="m5.4 16.4.6 1.6 1.6.6-1.6.6-.6 1.6-.6-1.6-1.6-.6 1.6-.6.6-1.6Z" />
    </>
  ),
  users: (
    <>
