    ...
    <>
      <Modal open={open && !deviceOpen} onClose={onClose} title={t("accounts.add")} width={440}>
        <div className="add-options">
          <button className="add-option card-hover" data-glow onClick={() => setDeviceOpen(true)}>
          ...
          <button className="add-option card-hover" data-glow onClick={() => void browserLogin()}>
          ...
          <button
            className="add-option card-hover" data-glow
            onClick={() => {
              void importOfficial();
              onClose();
            }}
